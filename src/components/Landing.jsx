  ...
  return (
    <div className="min-h-screen w-full  flex flex-col justify-center items-center relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center  mb-6 text-center">
        ...
        <p className="text-[#66564a] text-md md:text-lg italic animate-fade-in delay-400 px-2 Neirizi">
      ...
      {/* البطاقة */}
      <div className="relative z-10 w-11/12 md:w-2/3 lg:w-1/2 xl:w-1/3">
        <div className="backdrop-blur-md bg-white/60 border border-[#e6d9b9]  rounded-3xl p-6 flex flex-col items-center transition-transform duration-500 animate-fade-in delay-500">
          <img src={cardImage} alt="Wedding" className="w-2/3 h-auto object-cover rounded-2xl " />
